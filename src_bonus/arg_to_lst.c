...
/*   Updated: 2024/02/05 10:49:34 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap_bonus.h"

static int	check_and_add_list(char *arg, t_list **head, char **tab)
{
	long long	nbr;
	int			*ptr;
	t_list		*lst;
...
static void	managing_arg(int ac, char **av, t_list **head)
{
	int		i;
	int		j;
	char	**tab_arg;
